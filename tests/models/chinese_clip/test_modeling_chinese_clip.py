...
class ChineseCLIPVisionModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    all_model_classes = (ChineseCLIPVisionModel, ChineseCLIPVisionModelWithProjection) if is_torch_available() else ()
    fx_compatible = False
    test_pruning = False
...
class ChineseCLIPTextModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    all_model_classes = (ChineseCLIPTextModel, ChineseCLIPTextModelWithProjection) if is_torch_available() else ()
    fx_compatible = False
    test_pruning = False
    test_head_masking = False
