...
def load_tf2_weights_in_chinese_clip(model, tf_checkpoint_path, config):
...
def convert_tf2_checkpoint_to_pytorch(tf_checkpoint_path, config_path, pytorch_dump_path):
    ...
    load_tf2_weights_in_chinese_clip(model, tf_checkpoint_path, config)
...
if __name__ == "__main__":
    ...
    convert_tf2_checkpoint_to_pytorch(args.tf_checkpoint_path, args.chinese_clip_config_file, args.pytorch_dump_path)
