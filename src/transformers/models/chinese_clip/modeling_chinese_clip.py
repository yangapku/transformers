...
# Copied from transformers.models.clip.modeling_clip.clip_loss with clip->chinese_clip
...
@dataclass
# Copied from transformers.models.clip.modeling_clip.CLIPTextModelOutput with CLIP->ChineseCLIP
...
@dataclass
# Copied from transformers.models.clip.modeling_clip.CLIPOutput with CLIP->ChineseCLIP
...
# Copied from transformers.models.clip.modeling_clip.CLIPTextEmbeddings with CLIP->ChineseCLIP
...
# Copied from transformers.models.clip.modeling_clip.CLIPPreTrainedModel with CLIP->ChineseCLIP,clip->chinese_clip
class ChineseCLIPPreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        elif isinstance(module, ChineseCLIPVisionModelWithProjection):
            nn.init.normal_(
                module.visual_projection.weight,
                std=self.config.hidden_size**-0.5 * self.config.initializer_factor,
            )
        elif isinstance(module, ChineseCLIPTextModelWithProjection):
            nn.init.normal_(
                module.text_projection.weight,
                std=self.config.hidden_size**-0.5 * self.config.initializer_factor,
            )
...
@add_start_docstrings(
    """
    CHINESE_CLIP Text Model with a projection layer on top (a linear layer on top of the pooled output).
    """,
    CHINESE_CLIP_START_DOCSTRING,
)
class ChineseCLIPTextModelWithProjection(ChineseCLIPPreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(CHINESE_CLIP_TEXT_INPUTS_DOCSTRING)
    @replace_return_docstrings(output_type=ChineseCLIPTextModelOutput, config_class=ChineseCLIPTextConfig)
    def forward(
        self,
        input_ids: Optional[torch.Tensor] = None,
        attention_mask: Optional[torch.Tensor] = None,
        ...
        ```python
        >>> from transformers import CLIPTokenizer, ChineseCLIPTextModelWithProjection
...
@add_start_docstrings(
    """
    CHINESE_CLIP Vision Model with a projection layer on top (a linear layer on top of the pooled output).
    """,
    CHINESE_CLIP_START_DOCSTRING,
)
class ChineseCLIPVisionModelWithProjection(ChineseCLIPPreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(CHINESE_CLIP_VISION_INPUTS_DOCSTRING)
    @replace_return_docstrings(output_type=ChineseCLIPVisionModelOutput, config_class=ChineseCLIPVisionConfig)
    def forward(
        self,
        pixel_values: Optional[torch.FloatTensor] = None,
        output_attentions: Optional[bool] = None,
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from transformers import CLIPProcessor, ChineseCLIPVisionModelWithProjection
